...
function Footer() {
  return (
    <div data-scroll  data-scroll-speed='-.2' className='bg-gray-600 flex gap-5 w-full h-screen p-20 font-["Founders_Grotesk_X-Condensed"]'>
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[7vw]  font-semibold uppercase -mb-16">Eye-</h1>
          <h1 className="text-[7vw]  font-semibold uppercase -mb-20">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[5.5vw]  font-semibold uppercase tracking-tighter ">
          Presentations
        </h1>
        <div className="detail mt-10 font--['Neue_Montreal']">
        {["Facebook", "Instagram", "Twitter"].map((item)=>(
          <a className="block text-xl font-light " href="#">{item}</a>
